                ...
                <div className={styles.chatContainer}>
                    {!lastQuestionRef.current ? (
                        <div className={styles.chatEmptyState}>
                            ...
                            <h1 className={styles.chatEmptyStateTitle}>Chat with Volpara SQA Test Cases</h1>
                    ...
                    <div className={styles.chatInput}>
                        <QuestionInput
                            clearOnSend
                            placeholder="What are the typical prerequisites and steps involved in executing a test case for system integration with Single Sign-On (SSO) enabled?"
                            disabled={isLoading}
